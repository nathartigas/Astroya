...
export async function POST(req: NextRequest) {
    try {
        ...
        const response = await fetch(
            "https://script.google.com/macros/s/AKfycbxaZppD3aW2CLNCnRZesZvpqJogGHxqvxmcSNO8Ipp5M65rThEP82n4zun35fN1KBZ-/exec",
            {
                method: "POST",
        ...
        return NextResponse.json({ error: "Erro ao enviar para Google Sheets" }, { status: 500 })
    }
}
...
export function ConsultoriaModal({ isOpen, onClose }: ConsultoriaModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            <div className="relative w-full max-w-3xl mx-auto bg-zinc-950 rounded-2xl border border-zinc-800 p-6 md:p-8 shadow-2xl max-h-[90vh] flex flex-col">
